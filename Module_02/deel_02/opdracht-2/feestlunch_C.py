...
crossaintjes_prijs = int,float(input ('vul hier de prijs in centen = '))
stokbroden =  int(input("vul hier de aantal stokbroden = "))
stokbroden_prijs = int,float(input('vul hier de prijs van de stokbroden in centen = '))
korting = int(input ('vul hier de aantal kortingsbonen ='))
korting_C = int,float(input ('Vul hier de prijs van de kortingbonnen ='))

prijs = int(crossaintjes * crossaintjes_prijs / 100 + stokbroden * stokbroden_prijs / 100 - korting * korting_C / 100)

print (f"De feestlunch kost je {crossaintjes*crossaintjes_prijs + stokbroden*2-korting} euro voor de  croissantjes en de {stokbroden} stokbroden als de 3 kortingsbonnen nog geldig zijn")
