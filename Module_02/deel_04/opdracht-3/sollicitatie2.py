...
if naam == "papi":
    raise NameError ("papi is gevaarlijke naam!")

diploma = input('Ben je bezit van een Diploma MBO-4 ondernemen ja/ofnee ?')

if diploma == "nee":
    raise NameError ("jij bent een ezel")
vrachtwagen_R = input('ben je bezit van een geldig Vrachtwagen rijbewijs ja/of ?')               
hoge_hoed = input('ben je  bezit van een hoge hoed ja/of ?')
...
if gewicht == 150:
    raise NameError ("jij bent sws niet gezond")
